...
router.post("/", (req, res) => {
  const newAwakeNightStaffSignoff = new AwakeNightStaffSignoff({
    ...
    ts1YouthStatus: req.body.ts1YouthStatus,
    ts2YouthStatus: req.body.ts2YouthStatus,
    ts3YouthStatus: req.body.ts3YouthStatus,
    ts4YouthStatus: req.body.ts4YouthStatus,
    ts5YouthStatus: req.body.ts5YouthStatus,
    ts6YouthStatus: req.body.ts6YouthStatus,
    ts7YouthStatus: req.body.ts7YouthStatus,
    ts8YouthStatus: req.body.ts8YouthStatus,
    ts9YouthStatus: req.body.ts9YouthStatus,
    ts10YouthStatus: req.body.ts10YouthStatus,
    ts11YouthStatus: req.body.ts11YouthStatus,
    ts12YouthStatus: req.body.ts12YouthStatus,
    ts13YouthStatus: req.body.ts13YouthStatus,
    ts14YouthStatus: req.body.ts14YouthStatus,
    ts15Youthstatus: req.body.ts15Youthstatus,
    ts16YouthStatus: req.body.ts16YouthStatus,
    ts17YouthStatus: req.body.ts17YouthStatus,
    ts18YouthStatus: req.body.ts18YouthStatus,
    ts19YouthStatus: req.body.ts19YouthStatus,
    ts20YouthStatus: req.body.ts20YouthStatus,
    ts21YouthStatus: req.body.ts21YouthStatus,
    ts22YouthStatus: req.body.ts22YouthStatus,
    ts23YouthStatus: req.body.ts23YouthStatus,
    ts24YouthStatus: req.body.ts24YouthStatus,
    ts25YouthStatus: req.body.ts25YouthStatus,
    ts26YouthStatus: req.body.ts26YouthStatus,
    ts27YouthStatus: req.body.ts27YouthStatus,
    ts28YouthStatus: req.body.ts28YouthStatus,
    ts29YouthStatus: req.body.ts29YouthStatus,
    ts30YouthStatus: req.body.ts30YouthStatus,
    ts31YouthStatus: req.body.ts31YouthStatus,
    ts32YouthStatus: req.body.ts32YouthStatus,
    ts33YouthStatus: req.body.ts33YouthStatus,
    ts34YouthStatus: req.body.ts34YouthStatus,
    ts35YouthStatus: req.body.ts35YouthStatus,
    ts36YouthStatus: req.body.ts36YouthStatus,
    ts37YouthStatus: req.body.ts37YouthStatus,
    ts38YouthStatus: req.body.ts38YouthStatus,
    ts39YouthStatus: req.body.ts39YouthStatus,
    ts40YouthStatus: req.body.ts40YouthStatus,
    ts41YouthStatus: req.body.ts41YouthStatus,
    ts42YouthStatus: req.body.ts42YouthStatus,
    ts43YouthStatus: req.body.ts43YouthStatus,
    ts44YouthStatus: req.body.ts44YouthStatus,
    ts45YouthStatus: req.body.ts45YouthStatus,
    ts46YouthStatus: req.body.ts46YouthStatus,
    ts47YouthStatus: req.body.ts47YouthStatus,
    ts48YouthStatus: req.body.ts48YouthStatus,
    ts49YouthStatus: req.body.ts49YouthStatus,
    ts50YouthStatus: req.body.ts50YouthStatus,
